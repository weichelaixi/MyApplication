...
import com.weiche.module_common.utils.StringUtils;
...
public class Mipush_Broadcast extends PushMessageReceiver {
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage message) {
        ...
        } else if(!StringUtils.isEmpty(message.getUserAccount())) {
            mUserAccount=message.getUserAccount();
        }
        KeepLog.e("com.chewei.myapplication",message.getContent());
    }
    @Override
